  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button suppressHydrationWarning variant="ghost" size="sm" className="gap-1.5 text-muted-foreground hover:text-foreground h-12 w-12 p-0 sm:h-auto sm:w-auto sm:px-3" aria-label="Help">
          <HelpCircle className="w-6 h-6 sm:w-4 sm:h-4" />
